(()=>{
  ...
  function addStyle(){
    ...
    s.textContent=`
      ...
      .club999-whofor-row-v136{position:relative!important;display:grid!important;grid-template-columns:29px minmax(0,1fr)!important;align-items:center!important;gap:9px!important;width:100%!important;min-height:0!important;height:auto!important;margin:0!important;padding:8px 10px!important;box-sizing:border-box!important;border:1px solid rgba(234,199,101,.34)!important;border-radius:13px!important;background:linear-gradient(135deg,rgba(15,86,96,.43),rgba(4,35,47,.52))!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.075),0 4px 12px rgba(0,10,18,.07)!important;backdrop-filter:blur(14px) saturate(118%)!important;-webkit-backdrop-filter:blur(14px) saturate(118%)!important;overflow:hidden!important;list-style:none!important}
      ...
      .club999-whofor-icon-v136{position:relative!important;z-index:1!important;width:28px!important;height:28px!important;display:grid!important;place-items:center!important;border-radius:8px!important;border:1px solid rgba(239,204,104,.64)!important;background:radial-gradient(circle at 35% 28%,rgba(248,221,141,.18),transparent 38%),linear-gradient(145deg,rgba(11,82,94,.88),rgba(3,31,40,.96))!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.04),0 0 7px rgba(223,183,62,.13)!important}
      .club999-whofor-icon-v136 svg{width:19px!important;height:19px!important;fill:none!important;stroke:#f2d47d!important;stroke-width:1.55!important;stroke-linecap:round!important;stroke-linejoin:round!important;filter:drop-shadow(0 0 2px rgba(242,212,125,.28))!important}
      .club999-whofor-icon-v136 .dot{fill:#f2d47d!important;stroke:#f2d47d!important}
      .club999-whofor-copy-v136{position:relative!important;z-index:1!important;min-width:0!important;margin:0!important;padding:0!important;color:#f8f3e8!important;font-size:15.5px!important;line-height:1.2!important;font-weight:650!important;text-align:left!important;overflow-wrap:normal!important;word-break:normal!important}
      ...
      @media(min-width:701px){.club999-whofor-row-v136{padding:9px 11px!important;grid-template-columns:30px minmax(0,1fr)!important}.club999-whofor-icon-v136{width:29px!important;height:29px!important}.club999-whofor-copy-v136{font-size:16px!important}}
    `;
